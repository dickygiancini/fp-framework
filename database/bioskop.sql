...
--
ALTER TABLE `transaksi`
  ADD CONSTRAINT `FK_TRANSAKS_RELATIONS_CUSTOMER` FOREIGN KEY (`ID_CUST`) REFERENCES `customer` (`ID_CUST`),
  ADD CONSTRAINT `FK_TRANSAKS_RELATIONS_FILM` FOREIGN KEY (`KODE_FILM`) REFERENCES `film` (`KODE_FILM`),
  ADD CONSTRAINT `FK_TRANSAKS_RELATIONS_JADWAL` FOREIGN KEY (`ID_JADWAL`) REFERENCES `jadwal` (`ID_JADWAL`),
  ADD CONSTRAINT `FK_TRANSAKS_RELATIONS_STUDIO` FOREIGN KEY (`KODE_STUDIO`) REFERENCES `studio` (`KODE_STUDIO`),
  ADD CONSTRAINT `FK_TRANSAKS_RELATIONS_TIKET` FOREIGN KEY (`KODE_TIKET`) REFERENCES `tiket` (`KODE_TIKET`);
COMMIT;
